...
const featuredAgents = [
  {
    ...
    description: 'Advanced AI-powered qualification verification with red flag detection and expert-level assessment',
    price: 199.99,
    originalPrice: 299.99,
    status: 'Popular',
    category: 'compliance',
    level: 'advanced',
    benefits: ['Automated compliance checking', 'Expert-level analysis quality', 'Immediate breach detection'],
    available: true
  },
  {
    id: 'salary',
    title: 'AI Salary Compliance Agent',
    description: 'Comprehensive salary compliance analysis with payslip verification and NMW checking',
    price: 179.99,
...
const allAgents = [
  ...
  },
  {
    ...
    category: 'compliance',
    level: 'advanced',
    benefits: ['Real-time status monitoring', 'Automated compliance checking', 'Timely alert system'],
    available: false
  },
  {
    id: 'record-keeping',
  ...
  },
  {
    ...
    category: 'compliance',
    level: 'advanced',
    benefits: ['Automated hours monitoring', 'Contract compliance assurance', 'Hours verification'],
    available: false
  },
  {
    id: 'paragraph-c7-26',
    ...
    category: 'compliance',
    level: 'enterprise',
    benefits: ['Specialized C7-26 monitoring', 'Requirement compliance assurance', 'Specialized guidance'],
    available: false
  }
];
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <Badge variant={agent.status === 'Popular' ? 'default' : 'secondary'}>
                          {agent.status}
                        </Badge>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Expert-Level Analysis</h3>
              <p className="text-gray-600">AI that matches human expert assessment quality</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Get compliance reports in seconds, not hours</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">100% UK Compliant</h3>
              <p className="text-gray-600">Built specifically for UK sponsor requirements</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">AI that improves with every assessment</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/products" className="hover:text-white transition-colors">Digital Tools</Link></li>
                <li><Link href="/ai-agents" className="hover:text-white transition-colors">AI Agents</Link></li>
                <li><a href="https://dragon.sponsorcomplians.co.uk" className="hover:text-white transition-colors">Dragon AI</a></li>
              </ul>
            </div>
