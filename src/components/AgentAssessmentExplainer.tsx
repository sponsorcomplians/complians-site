...
const agentExplainers: Record<string, { agentName: string; summary: string; points: string[] }> = {
  'ai-qualification-compliance': {
    agentName: 'AI Qualification Compliance Agent',
    summary: 'Automatically reviews uploaded qualification documents for compliance with UK Home Office requirements.',
    points: [
  ...
  'ai-salary-compliance': {
    ...
    summary: 'Analyzes payslips and salary documents for NMW and Home Office threshold compliance.',
    points: [
  ...
  'ai-skills-experience-compliance': {
    ...
    summary: 'Reviews CVs and experience records for role suitability and compliance.',
    points: [
  ...
  'ai-record-keeping-compliance': {
    ...
    summary: 'Checks document management and record keeping for sponsor compliance.',
    points: [
...
export default function AgentAssessmentExplainer() {
  ...
  const agentKey = pathname?.split('/').find((seg) => seg.startsWith('ai-')) || '';
    ...
    <div className="mb-4">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-semibold text-[#263976]">What does this AI Agent do?</span>
        </div>
