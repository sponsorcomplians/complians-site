...
function ComplianceArea4Section({
  data,
  onChange,
  onSave
}: ComplianceArea4SectionProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Migrant Tracking & Monitoring</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="space-y-4">
          <h3 className="text-lg font-semibold">Required Documents</h3>
          <p className="text-sm text-muted-foreground">
            The following documents must be maintained to track and monitor
            sponsored workers:
          </p>
...
/>
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-0" align="start">
                          <Calendar
                            ...
                            selected={
                              data[dateKey]
                                ? new Date(data[dateKey] as string)
                                : undefined
                            }
                            onSelect={(date) =>
                              handleFieldChange(
        ...
        <div className="space-y-4">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-yellow-700">
              <li>• You must keep a record of the migrant's address history</li>
              <li>
                • You must ask the migrant to complete the 'Change of Contact
                Form' after moving to a new address
              </li>
              <li>• All contact details must be kept up to date in the system</li>
              <li>• Regular activity reports must be submitted as required</li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-blue-700">
              <li>• Sponsored worker does not start within 28 days</li>
              <li>
                • Absent without permission for more than 10 consecutive working
                days
              </li>
              <li>
                • Absent without pay for more than 4 weeks total in any calendar
                year
              </li>
              <li>• Salary reduced from the level stated on their CoS</li>
              <li>• Significant changes to employment details</li>
              <li>• Normal work location changes</li>
              <li>• You stop sponsoring a worker for any reason</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex justify-end pt-4">
          <Button onClick={() => onSave('compliance_area_4')}>
...
export default ComplianceArea4Section;
