// src/components/sw002/sections/ComplianceArea3Section.tsx
'use client';
...
export default function ComplianceArea3Section({ data, onChange, onSave }: ComplianceArea3SectionProps) {
  ...
  const documents = [
    { code: 'SW013', name: 'Passport', field: 'sw013', required: true },
    { code: 'SW014', name: 'Certificate of Sponsorship', field: 'sw014', required: true },
    { code: 'SW015', name: 'Home Office Decision Letter', field: 'sw015', required: true },
    { code: 'SW016', name: 'Visa Vignette with entry stamp', field: 'sw016', required: true },
    { code: 'SW017', name: 'BRP card (front)', field: 'sw017', required: true },
    { code: 'SW018', name: 'BRP card (back) showing NI number', field: 'sw018', required: true },
    { code: 'SW019', name: 'Right to work online check status', field: 'sw019', required: true },
    { code: 'SW020', name: 'DBS check certificate', field: 'sw020', required: false }
  ];
      ...
      <CardContent>
        <Tabs defaultValue="part1" className="w-full">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        <Checkbox
                          ...
                          checked={data.documents_part1[`${doc.field}_${doc.field.split('_')[1]}_original`] || false}
                          onCheckedChange={(checked) => 
                            handleFieldChange('documents_part1', `${doc.field}_${doc.field.split('_')[1]}_original`, checked)
                          }
                        />
                      ...
                      <div className="flex items-center gap-2">
                        <Checkbox
                          id={`${doc.field}_copy`}
                          checked={data.documents_part1[`${doc.field}_${doc.field.split('_')[1]}_copy`] || false}
                          onCheckedChange={(checked) => 
                            handleFieldChange('documents_part1', `${doc.field}_${doc.field.split('_')[1]}_copy`, checked)
                          }
                        />
                    ...
                    <div>
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button
                            ...
                            className={cn(
                              ...
                              !data.documents_part1[`${doc.field}_date`] && "text-muted-foreground"
                            )}
                          >
                            <CalendarIcon className="mr-2 h-4 w-4" />
                            {data.documents_part1[`${doc.field}_date`]
                              ? format(new Date(data.documents_part1[`${doc.field}_date`]), "dd/MM/yyyy")
                              : "Date seen/copied"
                            }
                          </Button>
                        </PopoverTrigger>
                        <PopoverContent className="w-auto p-0" align="start">
                          <Calendar
                            mode="single"
                            selected={data.documents_part1[`${doc.field}_date`] ? new Date(data.documents_part1[`${doc.field}_date`]) : undefined}
                            onSelect={(date) => handleFieldChange('documents_part1', `${doc.field}_date`, date?.toISOString())}
                            initialFocus
                          />
                        </PopoverContent>
                      </Popover>
          ...
          <TabsContent value="part2" className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button onClick={() => onSave('recruitment_evidence')}>
                <Save className="h-4 w-4 mr-2" />
                Save Part 2
              </Button>
            </div>
          ...
          <TabsContent value="part3" className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => 
                          handleFieldChange('salary_documents', 'sw024_contract_copy', checked)
                        }
                      />
                    ...
                    <div className="flex items-center gap-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => 
                          handleFieldChange('salary_documents', 'sw024_contract_signed', checked)
                        }
                      />
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => handleFieldChange('salary_documents', 'sw024_date', date?.toISOString())}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFieldChange('salary_documents', 'sw025_job_description_copy', checked)
                      }
                    />
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => handleFieldChange('salary_documents', 'sw025_date', date?.toISOString())}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFieldChange('salary_documents', 'sw026_qualifications_copy', checked)
                      }
                    />
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => handleFieldChange('salary_documents', 'sw026_date', date?.toISOString())}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
            ...
            <div className="flex justify-end">
              <Button onClick={() => onSave('salary_documents')}>
                <Save className="h-4 w-4 mr-2" />
                Save Part 3
              </Button>
            </div>
          ...
          <TabsContent value="part4" className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFieldChange('skill_evidence', 'sw027_references_copy', checked)
                      }
                    />
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => handleFieldChange('skill_evidence', 'sw027_date', date?.toISOString())}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleFieldChange('skill_evidence', 'sw028_test_type', e.target.value)}
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFieldChange('skill_evidence', 'sw028_english_language_copy', checked)
                      }
                    />
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => handleFieldChange('skill_evidence', 'sw028_date', date?.toISOString())}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleFieldChange('skill_evidence', 'sw029_country', e.target.value)}
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFieldChange('skill_evidence', 'sw029_police_clearance_copy', checked)
                      }
                    />
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => handleFieldChange('skill_evidence', 'sw029_date', date?.toISOString())}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFieldChange('skill_evidence', 'sw030_medical_certificates_copy', checked)
                      }
                    />
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => handleFieldChange('skill_evidence', 'sw030_date', date?.toISOString())}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
            ...
            <div className="flex justify-end">
              <Button onClick={() => onSave('skill_evidence')}>
                <Save className="h-4 w-4 mr-2" />
                Save Part 4
              </Button>
            </div>
