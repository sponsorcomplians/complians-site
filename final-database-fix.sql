...
-- Step 2: Add tenant_id to profiles table if it doesn't exist
DO $$ 
BEGIN
...
-- Step 3: Create audit_logs table with details column
...
-- Step 4: Create the missing check_rate_limit function
...
-- Step 5: Create the missing create_tenant_for_signup function
...
-- Step 6: Create the create_tenant_during_signup function (alternative name)
...
-- Step 7: Set up RLS policies for tenants table
...
-- Step 8: Set up RLS policies for audit_logs table
...
-- Step 11: Grant service role permissions
